...
@Autonomous(name = "Robotonics 3 Red", group = "Autonomous")
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(vumarkNotFound) {
            if (tracker.vumarkFound().equals(RelicRecoveryVuMark.LEFT)) {
                ...
                robot.driveBackwardWithEncoders(BALANCE_TO_CRYPTOBOX);
                robot.turnRightWithEncoders(QUARTER_TURN); //The glyph is already oriented correctly.
                robot.driveForwardWithEncoders(BALANCE_TO_RIGHT); //Because it equals zero.
                vumarkNotFound = false;
                break;
            }
        }
